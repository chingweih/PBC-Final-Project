...
class Page01(tk.Frame):
    ...
    def createButton(self):
        self.after(4000, lambda: self.bgcanvas.create_window(
...
class Page02(tk.Frame):
    ...
    def createButton(self):
        self.after(12000, lambda: self.bgcanvas.create_window(
            500, 600, anchor='nw', window=self.nextPage_B))
...
class Page04(tk.Frame):
    def __init__(self, parent, controller):
        ...
        words = tk.Label(self, text="各種小傑介紹", font=self.my_font1,
                         bg=bg_color, bd=0, fg=text_color)
        words1 = tk.Label(self, text="想了解各種小傑嗎？ \n要的話就點開各張照片吧！",
                          font=self.my_font, bg=bg_color, bd=0, fg=text_color)
...
class Page04_always_black(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent, width=1280, height=800,
                          bg=bg_color, bd=0, highlightthickness=0)
...
class Page06(tk.Frame):
    ...
    def createButton(self):
        self.after(22000, lambda: self.bgcanvas.create_window(
            500, 600, anchor='nw', window=self.nextPage_B))
